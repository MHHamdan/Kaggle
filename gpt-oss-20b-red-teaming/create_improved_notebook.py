#!/usr/bin/env python3
"""
Script to create an improved Kaggle notebook for the OpenAI Red-Teaming Challenge
Inspired by the baseline notebooks and using Hugging Face transformers approach
"""

import json

# Define the improved notebook structure
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
...
# Write the improved notebook to file
with open('kaggle_improved_notebook.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("✅ Improved Kaggle notebook created successfully!")
print("📁 File: kaggle_improved_notebook.ipynb")
print("🚀 Ready for upload to Kaggle!")
print("\\n🔑 Key Improvements:")
print("   - Uses Hugging Face transformers (more reliable than OpenAI API)")
print("   - Proper Kaggle environment setup")
print("   - Better error handling and debugging")
print("   - Optimized for GPU usage")
print("   - Follows baseline notebook patterns")
