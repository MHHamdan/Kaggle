...
class GPTOSSClient:
    ...
    def __init__(
        ...
        # Initialize OpenAI client without organization if not provided
        org_id = os.getenv("OPENAI_ORG_ID")
        if org_id and org_id != "your_organization_id_here" and org_id.strip():
    ...
    def generate_response(
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                # Handle usage data properly for JSON serialization
                if response.usage:
                    usage = {
